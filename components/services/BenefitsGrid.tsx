...
const BenefitCard: FC<BenefitCardProps> = ({ title, description, icon, index }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-white/40 dark:bg-white/5 rounded-xl pointer-events-none z-0"></div>
...
export const BenefitsGrid: FC<BenefitsGridProps> = ({ benefits, className }) => {
  return (
    <section className={cn("py-20 bg-[#F6F9FC]", className)}>
      <div className="max-w-screen-xl mx-auto px-4">
        <h3 className="text-3xl font-bold text-center mb-8">Key Benefits</h3>
        
        <AnimatedTypography 
          variant="p" 
          animation="fade" 
          delay={0.2}
          className="text-center mb-16 max-w-3xl mx-auto text-ignite-navy text-lg font-normal"
        >
